var PHYSICS_DATA = [
    ...
    },
    {
        ...
        "practice": [
            {
                "q": "The diagram shows a wave traveling to the right through a uniform medium. The dashed line represents the equilibrium (rest) position of one particle in the medium, and the arrow shows the direction of particle motion at the point marked X. What type of wave is shown in the diagram? Choose 1 answer:",
                "options": [
                    "A transverse wave",
                    "A longitudinal wave",
                    "A surface wave",
                ...
                "ansIdx": 0,
                "sol": "In a transverse wave, the particle displacement is perpendicular to the direction of wave propagation. Since the particle at X moves up/down while the wave travels right, the wave is transverse.",
                "hint": "Particle moves perpendicular to wave direction = transverse. Particle moves parallel = longitudinal.",
                "source": "KA transverse-and-longitudinal-wave-exercises-ap1 (AP Physics 1)"
            },
            {
                "q": "Two speakers simultaneously create sounds of slightly different frequencies (fA and fB). The variation in air pressure of the individual sound waves is measured by a microphone over time t. What adjustment can we make to reduce the beat frequency? Choose 1 answer:",
                "options": [
                    "Increasing fA",
                    "Increasing fB",
                    "Decreasing the speakers' volumes",
                    "Decreasing fB"
                ],
                "ansIdx": 3,
                "sol": "Beat frequency f_beat = |fA - fB|. To reduce the beat frequency, we must decrease the frequency difference — the only option that does this is decreasing fB (D).",
                "hint": "Beat frequency = the DIFFERENCE between the two frequencies. Which option reduces that difference?",
                "source": "KA beats-ap-physics-1 (AP Physics 1)"
            },
            {
                "q": "A speaker at rest plays a sound with constant frequency f0 near a straight train track. Train A moves toward the speaker, and train B moves away from the speaker. How does the frequency fA observed by a rider on train A compare to the frequency fB observed by a rider on train B? Choose 1 answer:",
                "options": [
                    "fA > fB",
                    "fA < fB",
                    "fA = fB",
                ...
                "ansIdx": 0,
                "sol": "Source moving toward observer → frequency goes UP (blue shift). Source moving away → frequency goes DOWN. Train A approaching hears a higher frequency than train B moving away — so fA > fB.",
                "hint": "Source moving toward observer → frequency goes UP. Source moving away → frequency goes DOWN.",
                "source": "KA doppler-effect-ap1 (AP Physics 1)"
            }
        ],
        "quiz": [
            {
                "q": "A sound wave is traveling through air. Which of the following statements about the wave is correct? Choose 1 answer:",
                "options": [
                    "The wave is a transverse wave because air particles move perpendicular to the direction of wave travel",
                    "The wave is a longitudinal wave because air particles move parallel to the direction of wave travel",
                    "The wave is a transverse wave because air particles move parallel to the direction of wave travel",
                    "The wave is a longitudinal wave because air particles move perpendicular to the direction of wave travel"
                ],
                "ansIdx": 1,
                "sol": "Sound waves in air are longitudinal: air particles compress and rarefy parallel to the direction the wave travels. Transverse waves need a medium that can support shear forces — air cannot.",
                "hint": "Sound in air is longitudinal — particles compress and expand in the SAME direction as the wave travels.",
                "source": "KA transverse-and-longitudinal-wave-exercises-ap1 (AP Physics 1)"
            },
            {
                "q": "Two waves of frequencies 300 Hz and 306 Hz superpose. What is the beat frequency heard? Choose 1 answer:",
                "options": [
                    "3 Hz",
                    "6 Hz",
                    "303 Hz",
                ...
                "ansIdx": 1,
                "sol": "Beat frequency = |f1 - f2| = |306 - 300| = 6 Hz. The ear hears this as a periodic waxing and waning of loudness.",
                "hint": "Beat frequency = the absolute difference between the two frequencies.",
                "source": "KA beats-ap-physics-1 (AP Physics 1)"
            },
            {
                "q": "An observer stands still while an ambulance drives toward them at constant speed, honking its horn. As the ambulance approaches and then passes the observer, which of the following best describes the change in the observed frequency? Choose 1 answer:",
                "options": [
                    "The frequency is higher than the emitted frequency while approaching, equals the emitted frequency at the instant of passing, and is lower after passing",
                    "The frequency is lower than the emitted frequency while approaching, equals the emitted frequency at the instant of passing, and is higher after passing",
                    "The frequency is higher than the emitted frequency at all times",
                    "The frequency is unchanged because the speed of sound in air is constant"
                ],
                "ansIdx": 0,
                "sol": "Doppler effect: approaching source → observed frequency higher than emitted; receding source → observed frequency lower. At the instant of passing, the source is neither approaching nor receding, so the observed frequency equals the emitted frequency.",
                "hint": "Approaching = frequency UP. Receding = frequency DOWN. At the moment of passing, relative motion is zero.",
                "source": "KA doppler-effect-ap1 (AP Physics 1)"
            }
        ],
        "practice2": [
    ...
    },
    {
        ...
        "practice": [
            {
                "q": "A substance changes directly from a solid to a gas without passing through a liquid phase. What is this process called? Choose 1 answer:",
                "options": [
                    "Melting (熔化)",
                    "Boiling (沸腾)",
                    "Sublimation (升华)",
                ...
                "ansIdx": 2,
                "sol": "Sublimation is the phase change from solid directly to gas — for example, dry ice (solid CO2) turning into carbon dioxide gas. Melting is solid→liquid; boiling is liquid→gas.",
                "hint": "Solid → gas directly, skipping the liquid phase. Which process has no liquid step?",
                "source": "KA changes-of-state (States of matter)"
            },
            {
                "q": "During the melting of ice at 0 degree C, the temperature remains constant even though heat is being supplied. Which of the following best explains this?",
                "options": [
                    "The ice is a poor conductor of heat",
                    "All the heat is used to change the state of the ice from solid to liquid, not to increase temperature",
                    "The surrounding air is at the same temperature as the ice",
                    "The heat capacity of ice is zero"
                ],
                "ansIdx": 1,
                "sol": "During a phase change at the melting point, all supplied heat goes into breaking the intermolecular bonds (latent heat of fusion) rather than increasing kinetic energy and temperature.",
                "hint": "Where does the heat go if the temperature is not rising? It is being used to change the state.",
                "source": "公立校真题·熔化和凝固 (人教版八上 第三章)"
            },
            {
                "q": "Which of the following is an example of condensation (液化)?",
                "options": [
                    "Snow melting into water",
                    "Water evaporating from a puddle",
                    "Water droplets forming on the outside of a cold drink glass",
                    "Dry ice disappearing in the air"
                ],
                "ansIdx": 2,
                "sol": "Condensation is gas → liquid. Water droplets on a cold glass are water vapor in the air that has condensed into liquid water.",
                "hint": "Condensation = gas cooling and turning into liquid. Which option starts with water vapor and ends with liquid water?",
                "source": "公立校真题·汽化和液化 (人教版八上 第三章)"
            },
            {
                "q": "On a cold winter morning, frost (霜) forms on the window glass. This frost most likely formed by which process?",
                "options": [
                    "Melting of water vapor",
                    "Condensation of water vapor followed by freezing",
                    "Deposition (凝华) of water vapor directly into ice",
                    "Evaporation of water from the glass surface"
                ],
                "ansIdx": 2,
                "sol": "Frost is ice crystals that form directly from water vapor without becoming liquid first — that is deposition (凝华), the reverse of sublimation.",
                "hint": "Frost is ice crystals on a cold surface, appearing without any liquid water first. Which process skips the liquid step?",
                "source": "公立校真题·升华和凝华 (人教版八上 第三章)"
            },
            {
                "q": "The boiling point of water on a high mountain is less than 100 degree C. This is because",
                "options": [
                    "The air temperature on the mountain is lower",
                    "The air pressure on the mountain is lower",
                    "The air on the mountain contains less oxygen",
                    "Water evaporates more quickly at high altitude"
                ],
                "ansIdx": 1,
                "sol": "Boiling occurs when the saturated vapor pressure of the liquid equals the external atmospheric pressure. At high altitude the atmospheric pressure is lower, so water boils at a lower temperature.",
                "hint": "Boiling point is the temperature at which vapor pressure = atmospheric pressure. Lower air pressure means... lower or higher boiling point?",
                "source": "公立校真题·汽化和液化 (人教版八上 第三章)"
            }
        ],
        "quiz": [
            {
                "q": "A student places a thermometer in a beaker of crushed ice and water mixture. The thermometer reads 0 degree C. The student then adds a large amount of salt to the mixture and stirs. What happens to the thermometer reading?",
                "options": [
                    "It rises above 0 degree C",
                    "It stays at 0 degree C",
                    "It falls below 0 degree C",
                    "It first rises, then falls below 0 degree C"
                ],
                "ansIdx": 2,
                "sol": "Adding salt to water lowers its freezing point (freezing-point depression). The ice-water-salt mixture reaches a new equilibrium at a temperature below 0 degree C.",
                "hint": "Salt lowers the freezing point of water. What does that do to the temperature at which ice melts?",
                "source": "公立校真题·熔化和凝固 (人教版八上 第三章)"
            },
            {
                "q": "A beaker of water is heated from 20 degree C to 80 degree C. Which of the following changes during this process?",
                "options": [
                    "The mass of the water only",
                    "The temperature of the water only",
                    "Both the temperature and the mass of the water",
                    "Neither the temperature nor the mass of the water"
                ],
                "ansIdx": 1,
                "sol": "Heating water from 20 to 80 degree C raises its temperature. The dominant change is temperature, not mass.",
                "hint": "Heating raises temperature. Does heating change the mass of the water itself?",
                "source": "公立校真题·物态变化综合 (人教版八上 第三章)"
            },
            {
                "q": "In a closed, insulated container, 500 g of ice at -10 degree C is heated uniformly. Which of the following correctly describes what happens?",
                "options": [
                    "The temperature rises steadily until all the ice has melted, then the temperature of the water rises again",
                    "The temperature stays at -10 degree C while the ice melts, then rises above 0 degree C",
                    "The temperature rises from -10 degree C to 0 degree C, stays at 0 degree C while the ice melts, then rises further",
                    "The temperature rises continuously throughout, with no pause at 0 degree C"
                ],
                "ansIdx": 2,
                "sol": "Heating ice from -10 to 0 degree C raises its temperature. At 0 degree C (the melting point), the heat supplied is used for the phase change (latent heat of fusion) — the temperature stays constant until all ice has melted.",
                "hint": "During melting, temperature stays at the melting point. What happens before and after all the ice has melted?",
                "source": "公立校真题·物态变化综合 (人教版八上 第三章)"
            }
        ],
        "practice2": [
        ...
        "practice": [
            {
                ...
                "ansIdx": 0,
                "sol": "For diffuse reflection the law of reflection still holds: angle of incidence = angle of reflection. The angle measured from the surface is complementary to the angle of incidence, not equal. Angle of incidence = 90° minus angle-from-surface. So statements I and III are true.",
                "hint": "Law of reflection applies to ALL surfaces. The angle from the surface is the complement of angle of incidence.",
                "source": "KA reflection-and-refraction (Light optics practice)"
            },
            {
                "q": "An object is placed 3 m in front of a plane mirror. A student walks toward the mirror until she is 1 m from the mirror. What is the distance between her image and the mirror now? Choose 1 answer:",
                "options": [
                    "1 m",
                    "2 m",
                    "3 m",
                ...
                "ansIdx": 0,
                "sol": "A plane mirror forms a virtual image at the same distance behind the mirror as the object is in front of it. The student is 1 m from the mirror, so the image is 1 m behind the mirror.",
                "hint": "Plane mirror rule: image distance behind = object distance in front. Symmetric about the mirror plane.",
                "source": "KA plane mirror imaging"
            },
            {
                "q": "A ray of light travels from glass into air. The ray in the glass makes an angle of 30 degrees with the normal at the glass-air interface. When the ray enters the air, which of the following is true? Choose 1 answer:",
                "options": [
                    "The ray bends away from the normal and the angle with the normal is greater than 30 degrees",
                    "The ray bends toward the normal and the angle with the normal is less than 30 degrees",
                    "The ray continues in a straight line without bending",
                    "The ray reflects back into the glass"
                ],
                "ansIdx": 0,
                "sol": "Glass (n ≈ 1.5) is denser than air (n = 1). Light going from denser to rarer bends away from the normal, so the angle in air is greater than the 30-degree angle of incidence.",
                "hint": "Denser to rarer: light speeds up and bends AWAY from the normal. n_glass > n_air.",
                "source": "KA refraction and Snell's Law"
            },
            {
                "q": "White light passes through a glass prism and splits into its component colors. Which statement best explains why dispersion occurs? Choose 1 answer:",
                "options": [
                    "Different colors of light have different speeds in glass, so they refract by different amounts",
                    "Only white light can pass through glass; other colors are absorbed",
                    "The prism converts white light into colored light by a chemical reaction",
                    "All colors travel at the same speed in glass but have different wavelengths in air"
                ],
                "ansIdx": 0,
                "sol": "The refractive index of glass differs slightly for each wavelength. Shorter wavelengths (blue/violet) are slowed more and refract more than longer wavelengths (red), so white light spreads into a spectrum.",
                "hint": "Recall n = c/v. If different colors have different speeds in glass, what does that mean for n? And Snell's law?",
                "source": "KA dispersion and color"
            },
            {
    ...
    },
    {
        ...
        "practice": [
            ...
            {
                "q": "An object is placed 15 cm from a convex lens. The focal length of the lens is 10 cm. Since f < u < 2f (10 < 15 < 20), the object is between F and 2F. Where is the image formed? Choose 1 answer:",
                "options": [
                    "Between the lens and the focal point (virtual image)",
                    "At 2F on the opposite side of the lens",
                    "At the focal point F",
                    "Between F and 2F on the opposite side of the lens (real, inverted, magnified)"
                ],
                "ansIdx": 3,
                "sol": "For a convex lens: u = 15 cm, f = 10 cm. Since f < u < 2f, the object is between F and 2F. This produces a real, inverted, magnified image beyond 2F on the opposite side.",
                "hint": "f < u < 2f → image beyond 2F, real, inverted, magnified. Remember the three cases: u > 2f, f < u < 2f, u < f.",
                "source": "KA convex lens image formation"
            },
            {
                "q": "Parallel rays of light are incident on a convex lens. After passing through the lens, the rays converge at a point on the principal axis. What is this point called? Choose 1 answer:",
                "options": [
                    "The optical centre",
                ...
                "ansIdx": 2,
                "sol": "By definition, the principal focus F of a convex lens is the point on the principal axis where rays parallel to the principal axis converge after refraction.",
                "hint": "Parallel rays → converge at a point. What is that point called?",
                "source": "KA convex lens definition"
            },
            {
                "q": "A person with myopia (near-sightedness) cannot see distant objects clearly. A concave (diverging) lens is used to correct this. Where is the image of distant objects focused in the uncorrected eye? Choose 1 answer:",
                "options": [
                    "Convex lens; image focused in front of the retina",
                    "Concave lens; image focused in front of the retina",
                    "Convex lens; image focused behind the retina",
                    "Concave lens; image focused behind the retina"
                ],
                "ansIdx": 1,
                "sol": "Myopia: the eye focuses distant objects IN FRONT of the retina (the eyeball is too long or the lens is too strong). A concave lens diverges light before it enters the eye, so the eye can focus it on the retina.",
                "hint": "Near-sighted: image forms before reaching the retina. Which lens spreads light apart?",
                "source": "KA myopia and corrective lenses"
            },
            {
                "q": "A magnifying glass (a convex lens) is used to read fine print. The print is placed just inside the focal length of the lens. What type of image is produced? Choose 1 answer:",
                "options": [
                    "Real and inverted",
                    "Virtual and erect",
                    "Real and magnified",
                ...
                "ansIdx": 1,
                "sol": "When u < f for a convex lens, the image is virtual, upright (erect), and magnified, on the same side as the object. This is how a magnifying glass works.",
                "hint": "u < f → virtual image (same side as object). u > f → real image. What do you see when you look through a magnifying glass?",
                "source": "KA magnifying glass and virtual images"
            }
        ],
        "quiz": [
            {
                "q": "A convex lens has a focal length of 8 cm. An object is placed at 24 cm from the lens (beyond 2F). What type of image is formed? Choose 1 answer:",
                "options": [
                    "Real, inverted, and diminished (smaller than the object)",
                    "Real, inverted, and magnified (larger than the object)",
                    "Virtual, upright, and magnified",
                    "Real, inverted, and the same size as the object"
                ],
                "ansIdx": 0,
                "sol": "u = 24 cm, f = 8 cm, 2f = 16 cm. u > 2f → object beyond 2F produces a real, inverted, DIMINISHED image between F and 2F.",
                "hint": "u > 2f → real, inverted, REDUCED. f < u < 2f → real, inverted, ENLARGED. u < f → virtual, upright.",
                "source": "KA convex lens imaging rules"
            },
            {
                "q": "The focal length of a concave lens is 20 cm. An object is placed 40 cm from the lens. What type of image is formed? Choose 1 answer:",
                "options": [
                    "Real and inverted",
                    "Virtual and erect",
                    "Real and magnified",
                ...
                "ansIdx": 1,
                "sol": "A concave lens ALWAYS produces a virtual, upright (erect) image regardless of object position. The image is on the same side as the object and is always diminished (smaller).",
                "hint": "Concave lenses always produce: virtual, upright (same side as object).",
                "source": "KA concave lens image formation"
            },
            {
                "q": "The power of a lens is +4 diopters. Which statement is correct? Choose 1 answer:",
                "options": [
                    "The lens is concave with focal length 0.25 m",
                    "The lens is convex with focal length 25 cm",
                    "The lens is convex with focal length 4 m",
                    "The lens is concave with focal length 25 cm"
                ],
                "ansIdx": 1,
                "sol": "Power P = 1/f (in metres). P = +4 D → f = 1/4 = 0.25 m = 25 cm. Positive power means converging (convex) lens.",
                "hint": "P = 1/f_metres. Positive = convex. 1/4 m = 25 cm.",
                "source": "KA lens power and diopters"
            }
        ],
        "practice2": [
            {
    ...
    },
    {
        ...
        "practice": [
            {
                "q": "A block of wood floats in water with 60% of its volume submerged. What is the density of the wood? Choose 1 answer:",
                "options": [
                    "0.4 g/cm3",
                    "0.6 g/cm3",
                    "0.8 g/cm3",
                ...
                "ansIdx": 1,
                "sol": "For a floating object, fraction submerged = density_object / density_fluid. 60% submerged means density_wood = 0.6 x density_water = 0.6 g/cm3.",
                "hint": "Floating object: fraction submerged = object density / fluid density. Density of water = 1 g/cm3.",
                "source": "KA density (density and specific gravity)"
            },
            {
                "q": "A solid metal sphere has a mass of 540 g and a radius of 3 cm. What is the density of the metal? (Volume of a sphere = 4/3 pi r^3) Choose 1 answer:",
                "options": [
                    "4.8 g/cm3",
                    "7.2 g/cm3",
                    "9.0 g/cm3",
                ...
                "ansIdx": 0,
                "sol": "V = (4/3) pi * 3^3 = 36 pi cm3 approximately 113 cm3. Density = mass / volume = 540 / 113 approximately 4.8 g/cm3.",
                "hint": "Density = mass / volume. First find the sphere's volume, then divide mass by volume.",
                "source": "KA density (density and specific gravity)"
            },
            {
                "q": "An object of mass 200 g has a volume of 250 cm3. Compared to the density of water (1 g/cm3), the object's density is",
                "options": [
                    "Less than water; it will float",
                    "Greater than water; it will sink",
                    "Equal to water; it will remain suspended",
                    "Cannot be determined without knowing the shape"
                ],
                "ansIdx": 0,
                "sol": "Density = 200 g / 250 cm3 = 0.8 g/cm3, which is less than water (1 g/cm3). An object less dense than water will float.",
                "hint": "Compute density = mass/volume. Is it greater than or less than 1 g/cm3?",
                "source": "公立校真题·质量与密度 (人教版八上 第六章)"
            },
            {
                "q": "A cube has sides of length 2 cm and a mass of 64 g. The density of the material of the cube is",
                "options": [
                    "8 g/cm3",
                    "16 g/cm3",
                    "32 g/cm3",
                ...
                "ansIdx": 0,
                "sol": "Volume = 2 x 2 x 2 = 8 cm3. Density = 64 g / 8 cm3 = 8 g/cm3.",
                "hint": "Cube volume = side^3. Then density = mass / volume.",
                "source": "公立校真题·质量与密度 (人教版八上 第六章)"
            },
            {
                "q": "The mass of a stone is 300 g. When it is fully immersed in water, it displaces 120 cm3 of water. The density of the stone is",
                "options": [
                    "0.4 g/cm3",
                    "2.0 g/cm3",
                    "2.5 g/cm3",
                ...
                "ansIdx": 2,
                "sol": "Volume of stone = volume of water displaced = 120 cm3 (by Archimedes principle). Density = mass / volume = 300 g / 120 cm3 = 2.5 g/cm3.",
                "hint": "Displaced water volume = stone volume (Archimedes). Density = mass / volume.",
                "source": "公立校真题·质量与密度 (人教版八上 第六章)"
            }
        ],
        "quiz": [
            {
                "q": "A solid cube of side 5 cm has a mass of 625 g. Its density is",
                "options": [
                    "5 g/cm3",
                    "25 g/cm3",
                    "125 g/cm3",
                ...
                "ansIdx": 0,
                "sol": "Volume = 5^3 = 125 cm3. Density = 625 g / 125 cm3 = 5 g/cm3.",
                "hint": "Cube volume = side^3. Then density = mass / volume.",
                "source": "公立校真题·质量与密度 (人教版八上 第六章)"
            },
            {
                "q": "A piece of metal has a density of 8.0 g/cm3 and a volume of 50 cm3. What is the mass of the piece of metal?",
                "options": [
                    "0.16 g",
                    "6.25 g",
                    "58 g",
                ...
                "ansIdx": 3,
                "sol": "Mass = density x volume = 8.0 g/cm3 x 50 cm3 = 400 g.",
                "hint": "Mass = density x volume. Multiply the two numbers.",
                "source": "公立校真题·质量与密度 (人教版八上 第六章)"
            },
            {
                "q": "Two blocks, A and B, have the same mass. Block A has a volume of 100 cm3 and block B has a volume of 200 cm3. Compared to the density of block A, the density of block B is",
                "options": [
                    "Half as great",
                    "The same",
                    "Twice as great",
                ...
                "ansIdx": 0,
                "sol": "Same mass but twice the volume means half the density: density_B = mass / 200 = (1/2) x (mass/100) = (1/2) x density_A.",
                "hint": "Density = mass/volume. Same mass, double the volume means... half the density.",
                "source": "公立校真题·质量与密度 (人教版八上 第六章)"
            }
        ],
        "practice2": [
