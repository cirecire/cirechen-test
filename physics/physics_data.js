...
// ══════════════════════════════════════════════════════════
{
  ...
  // KA subtopic structure: each subtopic = video(s) + practice question(s).
  subtopics: [
    { name: "§4.1 光的直线传播 · Rectilinear Propagation", vids: [], pq: [0] },
    { name: "§4.2 光的反射 · Reflection", vids: [0], pq: [1] },
    { name: "§4.3 平面镜成像 · Plane Mirror Images", vids: [1, 2], pq: [2] },
    { name: "§4.4 光的折射 · Refraction", vids: [3], pq: [3] },
    { name: "§4.5 光的色散 · Dispersion", vids: [4], pq: [4] },
  ],
  videos: [
    {yt: "XR52dXLyz-M", t: "Specular and diffuse reflection", ka: "https://www.khanacademy.org/science/physics/geometric-optics/reflection-refraction/v/specular-and-diffuse-reflection-2"},
    {yt: "nrOg85VPQgw", t: "Virtual image", ka: "https://www.khanacademy.org/science/physics/geometric-optics/reflection-refraction/v/virtual-image"},
    {yt: "8X1AS9qD5AQ", t: "Parabolic mirrors and real images", ka: "https://www.khanacademy.org/science/physics/geometric-optics/reflection-refraction/v/parabolic-mirrors-and-real-images"},
    {yt: "y55tzg_jW9I", t: "Refraction and Snell's law", ka: "https://www.khanacademy.org/science/physics/geometric-optics/reflection-refraction/v/refraction-and-snell-s-law"},
    {yt: "LksVHUrn8CI", t: "Dispersion", ka: "https://www.khanacademy.org/science/physics/geometric-optics/reflection-refraction/v/dispersion"},
  ],
  notes: [
...
// ══════════════════════════════════════════════════════════
{
  ...
  // KA subtopic structure: each subtopic = video(s) + practice question(s).
  subtopics: [
    { name: "§5.1 透镜 · Lenses", vids: [0, 1], pq: [0] },
    { name: "§5.2 生活中的透镜 · Lenses in Daily Life", vids: [], pq: [1] },
    { name: "§5.3 凸透镜成像的规律 · Imaging by a Convex Lens", vids: [2], pq: [2, 3] },
    { name: "§5.4 眼睛和眼镜 · The Eye & Glasses", vids: [3], pq: [4] },
  ],
  videos: [
    {yt: "K0sjZ5nqQ7g", t: "Convex lenses", ka: "https://www.khanacademy.org/science/physics/geometric-optics/lenses/v/convex-lenses"},
    {yt: "Vh70PyitQzo", t: "Concave lenses", ka: "https://www.khanacademy.org/science/physics/geometric-optics/lenses/v/concave-lenses"},
    {yt: "acQYX4nwhCk", t: "Object image height and distance relationship", ka: "https://www.khanacademy.org/science/physics/geometric-optics/lenses/v/object-image-height-and-distance-relationship"},
    {yt: "eji8zKa7H7s", t: "Diopters, aberration, and the human eye", ka: "https://www.khanacademy.org/science/physics/geometric-optics/lenses/v/diopters-aberration-and-the-human-eye"},
  ],
  notes: [
...
// ══════════════════════════════════════════════════════════
{
  ...
  // KA subtopic structure: each subtopic = video(s) + practice question(s).
  subtopics: [
    { name: "§6.1 质量 · Mass", vids: [0], pq: [0] },
    { name: "§6.2 密度 · Density", vids: [1], pq: [1, 2] },
    { name: "§6.3 测量物质的密度 · Measuring Density", vids: [], pq: [3] },
    { name: "§6.4 密度的应用 · Applications of Density", vids: [2], pq: [4] },
  ],
  videos: [
    {yt: "IuBoeDihLUc", t: "Mass and weight clarification", ka: "https://www.khanacademy.org/science/physics"},
    {yt: "QoKiCWCsSCo", t: "Volume density", ka: "https://www.khanacademy.org/science/physics"},
    {yt: "nVPrWz8Jfgo", t: "Specific gravity", ka: "https://www.khanacademy.org/science/physics"},
  ],
  notes: [
