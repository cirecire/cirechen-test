...
var MATH_DATA = [
    {
        ...
        "videos": [
            {
                "yt": "AA6RfgP-AHU",
                "t": "Intro to the Pythagorean theorem"
            },
            {
                "yt": "O64YFlX1_aI",
                "t": "Pythagorean theorem example"
            },
            {
                "yt": "TjOlZr_2uW4",
                "t": "Pythagorean theorem with isosceles triangle"
            },
            {
                "yt": "T0IOrRETWhI",
                "t": "Pythagorean theorem word problem: carpet"
            },
            {
                "yt": "JVrkLIcA2qw",
                "t": "Pythagorean theorem word problem: fishing boat"
            },
            {
                "yt": "1UQ5IbihJNI",
                "t": "Pythagorean theorem in 3D"
            },
            {
                "yt": "yZ4CbopnVBg",
                "t": "Find area of isosceles triangle"
            },
            {
                "yt": "nyZuite17Pc",
                "t": "Distance formula"
            ...
            {
                "yt": "EINpkcphsPQ",
                "t": "Garfield's proof of the Pythagorean theorem"
            },
            {
                "yt": "1ul8g55dYA4",
                "t": "Bhaskara's proof of the Pythagorean theorem"
            },
            {
                "yt": "LrS5_l-gk94",
            ...
            {
                "yt": "rcBaqkGp7CA",
                "t": "Another Pythagorean theorem proof"
            }
        ],
        "subtopics": [
            {
        ...
        "practice": [
            ...
            },
            {
                ...
                "options": [
                    "It is a right triangle, because $8^2 + 15^2 = 17^2$.",
                    "It is a right triangle, because $8^2 + 17^2 = 15^2$.",
                    "It is not a right triangle.",
                    "It is a right triangle, because $15^2 + 17^2 = 8^2$."
                ],
                "dia": {
                    "type": "triangle",
                    "w": "5",
            ...
            },
            {
                ...
                "options": [
                    "The third side must be $15$, because $9^2 + 12^2 = 15^2$.",
                    "The third side must be $21$, because $9 + 12 = 21$.",
                    "The third side must be $3$, because $12 - 9 = 3$.",
                    "The third side could be $15$ or $3$, depending on which side is the hypotenuse."
                ],
            ...
            },
            {
                ...
                "options": [
                    "$\\angle B$, because $7^2 + 24^2 = 25^2$.",
                    "$\\angle A$, because $7^2 + 25^2 = 24^2$.",
                    "$\\angle C$, because $24^2 + 25^2 = 7^2$.",
                    "$\\angle A$, because $AB$ is the longest side."
                ],
        ...
        "quiz": [
            ...
            },
            {
                ...
                "options": [
                    "It is a right triangle, because $9^2 + 40^2 = 41^2$.",
                    "It is not a right triangle.",
                    "It is a right triangle, but the right angle is not between the sides of length 9 and 40.",
        ...
        "practice2": [
            ...
            {
                "q": "An isosceles right triangle has hypotenuse $6sqrt{2}$. What is each leg?",
                "options": [
                    "$6$",
                    "$3$",
                    "$12$",
                ...
                "hint": "In an isosceles right triangle, hypotenuse $= \text{leg} \times sqrt{2}$. So leg $= 6sqrt{2} div sqrt{2} = 6$.",
                "ansIdx": 0,
                "sol": "Leg $= \frac{6sqrt{2}}{sqrt{2}} = 6$."
            },
            {
        ...
        "quiz2": [
            ...
            },
            {
                ...
                "hint": "$d = sqrt{5^2 + 5^2 + 5^2} = sqrt{75} = 5sqrt{3}$.",
                "ansIdx": 0,
                "sol": "Space diagonal $= sqrt{3 \times 5^2} = 5sqrt{3}$."
            },
            {
    ...
    },
    {
        ...
        "videos": [
            {
                "yt": "mbc3_e5lWw0",
                "t": "Intro to square roots"
            },
            {
                "yt": "EFVrAk61xjE",
                "t": "Approximating square roots to hundredths"
            },
            {
                "yt": "KibTbfkoPTs",
                "t": "Comparing irrational numbers with radicals"
            },
            {
                "yt": "87_qIofPwhg",
                "t": "Intro to cube roots"
            },
            {
                "yt": "DKh16Th8x6o",
                "t": "Worked example: Cube root of a negative number"
            },
            {
                "yt": "cLP7INqs3JM",
                "t": "Intro to rational & irrational numbers"
            },
            {
                "yt": "-QHff5pRdM8",
                "t": "Classifying numbers"
            }
        ],
        "notes": [
            ...
            "Rational number（有理数）: can be written as $\frac{p}{q}$ where $p, q$ are integers, $q eq 0$. Decimals are terminating or repeating.",
    ...
    },
    {
        ...
        "videos": [
            {
                "yt": "VhNkWdLGpmA",
                "t": "Points on the coordinate plane examples"
            },
            {
                "yt": "1op92ojA6q0",
                "t": "Quadrants of the coordinate plane"
            },
            {
                "yt": "b9H22F0Qbgw",
                "t": "Finding the point not graphed"
            },
            {
                "yt": "nyZuite17Pc",
                "t": "Distance formula"
    ...
    },
    {
        ...
        "videos": [
            ...
            {
                "yt": "Id6UovYjd-M",
                "t": "Worked example: Evaluating functions from equation"
            },
            {
                "yt": "3SO1BQQ9_1E",
                "t": "Testing if a relationship is a function"
            },
            {
                "yt": "AZroE4fJqtQ",
                "t": "Recognizing linear functions"
            },
            {
                "yt": "MeU-KzdCBps",
                "t": "Intro to slope"
            ...
            {
                "yt": "IL3UCuXrUzE",
                "t": "Intro to slope-intercept form (y=mx+b)"
            },
            {
                "yt": "uk7gS3cZVp4",
                "t": "Graph from slope-intercept equation"
            },
            {
                "yt": "xR9r38mZjK4",
                "t": "Linear graphs word problems"
            }
        ],
        "notes": [
    ...
    },
    {
        ...
        "coverage": "g",
        "think": "You buy 3 apples and 2 bananas for 11 dollars. Your friend buys 2 apples and 3 bananas for 9 dollars. Can you find the price of each fruit?",
        "subtopics": [
            {
                "name": "方程组入门",
                "vids": [
        ...
        "videos": [
            {
                "yt": "OcNt-36QKu8",
                "t": "Intro to systems of equations"
            },
            {
                "yt": "5a6zpfl50go",
                "t": "Systems of equations with graphing"
            },
            {
                "yt": "2EwPpga_XPw",
                "t": "Systems of equations with substitution: potato chips"
            },
            {
                "yt": "z1hz8-Kri1E",
                "t": "Systems of equations with elimination: TV & DVD"
            },
            {
                "yt": "Q0tTfe2lKIc",
                "t": "System of equations word problem: walk & ride"
            },
            {
                "yt": "KyHvVJWjW6Y",
                "t": "Number of solutions to systems of equations"
            }
        ],
        "notes": [
    ...
    },
    {
        ...
        "videos": [
            {
                "yt": "h8EYEJ32oQ8",
                "t": "Statistics intro: Mean, median, & mode"
            },
            {
                "yt": "k3aKKasOmIw",
                "t": "Mean, median, & mode example"
            },
            {
                "yt": "0ZKtsUkrgFQ",
                "t": "Representing data"
            ...
            {
                "yt": "gSEYtAjuZ-Y",
                "t": "How to make a histogram"
            },
            {
                "yt": "09Cx7xuIXig",
                "t": "Constructing a box and whisker plot"
            }
        ],
        "notes": [
    ...
    },
    {
        ...
        "videos": [
            ...
            {
                "yt": "H-E5rlpCVu4",
                "t": "Angles, parallel lines, & transversals"
            },
            {
                "yt": "2WjGD3LZEWo",
                "t": "Missing angles with a transversal"
            },
            {
                "yt": "6s1CI3uuhko",
                "t": "Angles in a triangle sum to 180 degrees proof"
            },
            {
                "yt": "hmj3_zbz2eg",
                "t": "Triangle exterior angle example"
            },
            {
                "yt": "7FTNWE7RTfQ",
                "t": "Isosceles & equilateral triangles problems"
            },
            {
                "yt": "yp49bc4TT-s",
                "t": "Corresponding parts of congruent triangles are congruent"
            }
        ],
        "notes": [
